...
export const NAV_MODULES: NavModuleDef[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { nameKey: 'nav.campuses', path: '/campuses', icon: School, roles: ['Super Admin', 'Admin', 'Principal'], moduleKey: 'campuses' },
      { nameKey: 'nav.classes', path: '/classes', icon: BookOpen, roles: ['Super Admin', 'Admin', 'Principal'], moduleKey: 'classes' },
      { nameKey: 'nav.staff', path: '/staff', icon: Briefcase, roles: ['Super Admin', 'Admin', 'Principal'], moduleKey: 'staff' },
  ...
  },
  {
    ...
    items: [
      { nameKey: 'nav.exams', path: '/exams', icon: ClipboardList, roles: ['Super Admin', 'Admin', 'Principal', 'Teacher'], moduleKey: 'exams' },
      { nameKey: 'nav.marksEntry', path: '/marks-entry', icon: ClipboardList, roles: ['Super Admin', 'Admin', 'Principal', 'Teacher'], moduleKey: 'exams' },
      { nameKey: 'nav.examAttendance', path: '/exam-attendance', icon: Calendar, roles: ['Super Admin', 'Admin', 'Principal', 'Teacher'], moduleKey: 'exam-attendance' },
    ],
  },
  {
    id: 'finance',
