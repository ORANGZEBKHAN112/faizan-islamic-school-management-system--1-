-- One-shot fresh install for SQL Server.
-- Run this in SSMS or Azure Data Studio with SQLCMD mode enabled.
-- Default database name matches the app's current .env.
--
-- In SSMS:
--   Query -> SQLCMD Mode
-- Then run this file.

:setvar DB_NAME FaizanIslamicSchool
